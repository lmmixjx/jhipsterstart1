...
public class Jhipsterstart1App {

    private static final Logger log = LoggerFactory.getLogger(Jhipsterstart1App.class);

    private final Environment env;

    public Jhipsterstart1App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterstart1.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Jhipsterstart1App.class);
